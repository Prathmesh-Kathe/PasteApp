...
const Paste = () => {
  ...
  const handleShare = () => {
    if (navigator.share) {
      navigator
        .share({
          title: "React Share Button Example",
          text: "Check out this awesome React share button!",
  ...
  return (
    <div className="w-full h-full py-1 max-w-[800px] mx-auto px-5 lg:px-0">
      <div className="flex flex-col gap-y-3">
        ...
        {/* All Pastes */}
        <div className="flex flex-col border border-[rgba(188,70,115,0.3)] py-4 rounded-[0.4rem]">
